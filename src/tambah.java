...
public class tambah extends JFrame {
	...
	public tambah() {
		...
		dateChooserSBY.getCalendarButton().addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			}
		});
		...
		JLabel lblNewLabelRute = new JLabel("BDG-SBY");
		...
		JLabel nokursi = new JLabel("........");
		nokursi.setBounds(619, 192, 46, 14);
		contentPane.add(nokursi);
		
		JButton kursi1 = new JButton("1");
		kursi1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					nokursi.setText("1");;
		...
		kursi1.setBounds(436, 27, 89, 23);
		contentPane.add(kursi1);
		
		JButton kursi2 = new JButton("2");
		kursi2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					nokursi.setText("2");;
		...
		kursi2.setBounds(559, 27, 89, 23);
		contentPane.add(kursi2);
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					if((      (JTextField)dateChooserSBY.getDateEditor().getUiComponent()).getText().isEmpty() ||         Jam.getText().isEmpty() || textFieldNam.getText().isEmpty() || textFieldTLP.getText().isEmpty() || textFieldCode.getText().isEmpty()){
						...
						String query2="insert into Surabaya(Rute,Tanggal, Jam, Jumlah, Harga, Nama, Telepon,KODETKT ) values(?,?,?,?,?,?,?,?)";
						...
						pst.setString(9, nokursi.getText());
					//	pts.setString(9, nokursi.getText());
						pst.execute();
						pts.execute();
		...
		textFieldNam.setFont(new Font("Arial", Font.PLAIN, 11));
		...
		textFieldTLP.setFont(new Font("Arial", Font.PLAIN, 11));
