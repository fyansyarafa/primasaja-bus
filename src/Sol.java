...
public class Sol extends JFrame {
	...
	public Sol() {
		...
		dateChooserSBY.getCalendarButton().setFont(new Font("Arial", Font.PLAIN, 11));
		...
		JLabel lblNewLabelRute = new JLabel("BDG-SOL");
		...
		button8.setFont(new Font("Arial", Font.BOLD, 11));
